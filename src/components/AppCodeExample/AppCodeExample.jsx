...
const AppCodeExample = () => {
  ...
  return (
    <section className={switcher ? 'dark' : null}>
      <div className="relative py-[60px] container px-0 sm:px-5">
        <div className="relative flex flex-col items-center pt-[60px] bg-[#F5F5F4] dark:bg-[#0F1214] rounded-2xl overflow-hidden transition-all duration-500">
          ...
          <div className="relative w-full max-w-[790px] rounded-t-[14px] bg-white dark:bg-[#282D32] shadow-xl transition-all duration-500">
            ...
            <div className="relative sm:absolute bottom-0 md:bottom-10 right-0 md:-right-4 lg:-right-10 w-full sm:w-[353px] -mt-2 sm:mt-0 py-5 px-6 rounded-2xl bg-white dark:bg-[#4D5258] text-sm sm:text-base text-black dark:text-white shadow-2xl transition-all duration-500">
