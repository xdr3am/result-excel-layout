  ...
  return (
    <div ref={pin} className="_pin h-[1000vh]">
      <section ref={section} className="_anim-section relative w-[500%] h-screen py-0 xl:py-[40px] flex flex-row overflow-hidden">
        ...
        <div ref={container} className="_anim-container-2 flex items-start md:items-center justify-center w-full h-full pt-[10vh] md:pt-0 mx-auto bg-black">
        ...
        <div ref={container} className="_anim-container-3 flex items-start md:items-center justify-center w-full h-full pt-[10vh] md:pt-0 mx-auto bg-black">
          <div className="container flex flex-col items-center pb-[20%] pt-10">
            <h2 className="max-w-[1000px] mb-10 md:mb-[80px] text-[28px] md:text-[54px] md:leading-[1.3] font-bold text-white text-center">
              Твои результаты после курса поместятся в одну простую модель
            </h2>
        ...
        <div ref={container} className="_anim-container-4 flex items-start md:items-center justify-center w-full h-full pt-[10vh] md:pt-0 mx-auto bg-black">
          <div className="container flex flex-col items-center pb-[20%] pt-10">
            <h2 className="max-w-[1000px] mb-10 md:mb-[80px] text-[28px] md:text-[54px] md:leading-[1.3] font-bold text-white text-center">
              Твои результаты после курса поместятся в одну простую модель
            </h2>
        ...
        <div ref={container} className="_anim-container-5 flex items-start md:items-center justify-center w-full h-full pt-[10vh] md:pt-0 mx-auto bg-black">
